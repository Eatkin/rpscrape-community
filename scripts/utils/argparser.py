...
from utils.course import course_name
from utils.course import course_search
from utils.course import courses
from utils.course import print_courses
from utils.course import valid_course
from utils.date import check_date
from utils.date import format_date
from utils.date import get_dates
from utils.date import parse_years
from utils.date import valid_years
from utils.paths import RequestKey
from utils.region import print_regions
from utils.region import region_search
...
class ArgParser:
    def __init__(self):
        self.parser: ArgumentParser = ArgumentParser(prog="rpscrape-community")
    ...
    def parse(self, argv: list[str]) -> ParsedRequest:
        ...
        if args.date_file:
            ...
            try:
                with open(args.date_file, encoding="utf-8") as f:
